...
git clone --depth=1 --filter=blob:none --sparse https://github.com/kenzok8/small-package.git && cd small-package && git sparse-checkout init --cone && git sparse-checkout set package/network/services/dnsmasq
